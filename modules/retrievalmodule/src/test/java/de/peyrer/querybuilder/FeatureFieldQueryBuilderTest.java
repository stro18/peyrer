...
public class FeatureFieldQueryBuilderTest {
    private FeatureFieldQueryBuilder featureFieldQueryBuilder;

    @Before
    public void setUp() {
        this.featureFieldQueryBuilder = new FeatureFieldQueryBuilder(0.42f);
    }

    @Test
    public void testGetQuery() throws ParseException {
        Query query = this.featureFieldQueryBuilder.getQuery("This iS a teSt Query");
