...
mongoimport --host mongo --db peyrer --collection args --file /argument_ndjson/debateorg.ndjson.ndjson --username root --password example --authenticationDatabase admin --mode=upsert  --upsertFields=id
